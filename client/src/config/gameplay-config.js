...
export const GAMEPLAY_CONFIG = freeze({
  ...
  waves: freeze({
    ...
    definitions: freeze([
      ...
      freeze({
        ...
        moveSpeed: 1.85,
        typeIds: freeze(['weak', 'medium', 'flying']),
      }),
      freeze({
        number: 3,
        enemyCount: 5,
        ...
        moveSpeed: 2.1,
        typeIds: freeze(['weak', 'medium', 'resistant', 'flying']),
      }),
      freeze({
        number: 4,
        enemyCount: 6,
  ...
  xr: freeze({
    ...
    aim: freeze({
      markerDistance: 4,
      markerInnerRadius: 0.065,
      markerOuterRadius: 0.09,
      trajectoryPointCount: 22,
      trajectoryStepSeconds: 0.075,
      trajectoryPointSize: 0.055,
    }),
    hud: freeze({
      canvasWidth: 1024,
      canvasHeight: 320,
      widthMeters: 1.08,
      heightMeters: 0.338,
      position: freeze({ x: 0, y: -0.36, z: -1.35 }),
    }),
  }),
  ...
  enemy: freeze({
    ...
    flying: freeze({
      ...
      maxAltitude: 9.5,
      hoverAmplitude: 0.48,
      hoverAngularSpeed: 2.6,
      chaseSpeedMultiplier: 1.18,
      diveSpeedMultiplier: 2.8,
      patrolRadius: 8.5,
      maxArenaRadius: 20,
      hoverDurationSeconds: 1.1,
      rangedDurationSeconds: 0.8,
      rangedFireDelaySeconds: 0.32,
      retreatDurationSeconds: 0.9,
      hitDurationSeconds: 0.28,
      deathDurationSeconds: 1.25,
