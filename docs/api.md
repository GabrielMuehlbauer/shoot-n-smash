...
O encontro da Fase 10 continua inteiramente no cliente e não adiciona endpoints.
O tipo sorteado, a resistência, a vida e o dano aplicado são estados locais do
