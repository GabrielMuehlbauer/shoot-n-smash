...
O gameplay da Fase 14 continua inteiramente no cliente e não adiciona endpoints.
Ondas, tipos, resistência, vida, dano e pontuação são estados locais e não são
enviados à API nesta etapa.
